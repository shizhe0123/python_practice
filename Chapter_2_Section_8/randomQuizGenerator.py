# -*- coding: utf-8 -*-
"""
Created on Tue Aug  7 08:33:28 2018
...
for quizNum in range(35):
    ...
    answerFile = open('quiz\\capitalaquiz_answer%s.txt' % (quizNum + 1), 'w')
    
    #wirte header of quiz file
    quizFile.write('Name:\n\nDate:\n\nPeriod:\n\n')
    quizFile.write((' ' * 20) + 'State Capitals Quiz (Form %s)' % (quizNum + 1))
    quizFile.write('\n\n')
    
    answerFile.write((' ' * 20) + 'Answer of Quiz Form %s' % (quizNum + 1))
    answerFile.write('\n')
